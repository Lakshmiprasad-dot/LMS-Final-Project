...
namespace LMS.Areas.Users.Controllers
{
    ...
    public class RateOfInterestsController : Controller
    {
        ...
        // GET: Users/RateOfInterests/Details/5
        ...
        // GET: Users/RateOfInterests/Create
        ...
        // POST: Users/RateOfInterests/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("RateOfInterestId,LoanAmount1,LoanId")] RateOfInterest rateOfInterest)
        {
            ...
            ViewData["LoanId"] = new SelectList(_context.LoanTypes, "LoanId", "Details", rateOfInterest.LoanId);
            return View(rateOfInterest);
        }

        // GET: Users/RateOfInterests/Edit/5
        ...
        // POST: Users/RateOfInterests/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RateOfInterestId,LoanAmount1,LoanId")] RateOfInterest rateOfInterest)
        {
        ...
        // GET: Users/RateOfInterests/Delete/5
        ...
        // POST: Users/RateOfInterests/Delete/5
