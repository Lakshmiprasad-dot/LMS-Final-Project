...
namespace LMS.Areas.Admins.Controllers
{
    ...
    public class LoanEligibilitiesController : Controller
    {
        ...
        // GET: Admins/LoanEligibilities/Details/5
        ...
        // GET: Admins/LoanEligibilities/Create
        ...
        // POST: Admins/LoanEligibilities/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("LoanEligibilityId,AgeLimit,Nationality,TypeOfEmployment,MonthlyIncome,LoanId,LoanType")] LoanEligibility loanEligibility)
        {
            // Check for Duplicates
            bool isFound = _context.LoanEligibility.Any(c => c.LoanId == loanEligibility.LoanId);
            if (isFound)
            {
            ...
            ViewData["LoanId"] = new SelectList(_context.LoanTypes, "LoanId", "LoanName", loanEligibility.LoanId);
            return View();
        }

        // GET: Admins/LoanEligibilities/Edit/5
        ...
        // POST: Admins/LoanEligibilities/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LoanEligibilityId,AgeLimit,Nationality,TypeOfEmployment,MonthlyIncome,LoanId")] LoanEligibility loanEligibility)
        {
            ...
            bool isFound = await _context.LoanEligibility
                .AnyAsync(c => c.LoanId == loanEligibility.LoanId
                               || c.LoanType == loanEligibility.LoanType);
            if (isFound)
            {
                ModelState.AddModelError("LoanId", "Duplicate Loan Type Found!");
            }
        ...
        // GET: Admins/LoanEligibilities/Delete/5
        ...
        // POST: Admins/LoanEligibilities/Delete/5
